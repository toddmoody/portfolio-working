                ...
                <MinHeader />
                    <div className="work-header wrapper">
                        ...
                        <div className="work-title">
                            ...
                            <p>RFT Engineering needed a website to start developing their digital presence and acquire new leads and customers. The main objectives were centered around promoting and clarifying their wide range of services (incl. non-standard Engineering Services available via third parties), and; using their extensive library of project photos effectively to showcase their projects. Organic search was also an important consideration over the longer-term.</p>
                    ...
                    <div id="tech" className="tech-block wrapper">
                        <div className="content-wrapper">
                            <h2>Technical info & tooling</h2>
                                <h3>Build</h3>
                                    <p>As I mentioned, I decided to build in React (using Create-React-App). Yes, I could have achieved a similar end result using standard markup, styling and vanilla JS and I'm really conscious as a developer not to always reach for the latest tools without good reason. So here's why React seems to be my go-to at the moment...</p>
                                        <ol>
                                            ...
                                            <li>When I'm ready to update my production bundle, it's a single NPM command and I'm done including optimised/minified JS & SASS. No separate Webpack set-up and configuration.</li>
                                            <li>Performance. It's fast! Yes, React is a reasonably large dependency but in my experience it's very fast, even for smaller apps.</li>
                                            <li>Lastly, I'm enjoying the process/React way of doing things and even getting used to seeing my markup, or more accurately JSX and JS merged in a single file. There was a time I never thought I would say that!</li>
                                        </ol>
                                <h3>Styling</h3>
                                    <p>I used SASS for this application as I think it works nicely with the component based nature of React. However, I prefer to maintain separate SASS files (usually separate ones for larger components). That may change in future as I understand React best-practices would recommend using style objects in the JS file. However for me, as I'm also maintaining a number of vanilla JS applications that don't support style objects, I'd prefer to stick separate files. Again, not specific to this project but I'm also just enjoying the nesting and variable capabilities of SASS.</p>
                                <h3>Challenges & roadblocks</h3>
                                    <p>This project was really smooth and it's always great to have a happy client. I feel like spending a solid amount of time on UI/IX, in particular solid wireframes was a big factor and the process of going from sketches, to low-fidelity wires, and then finally high-fidelity designs. If interested, I've created a separate project feature on outlining my process there in more depth.</p>
                        </div>
